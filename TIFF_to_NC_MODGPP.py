...
years=range(2000,2018+1) # Start and end year
...
def tiff_to_netcdf(input_dir, output_dir, years, tempo):
    ...
    for year in range(len(years)):
        ...
        # Create NetCDF file
        out_file = os.path.join(output_dir,'GPP.MOD.v006.'+str(years[year])+'.8-day.CMG_0.05.nc')
        ...
        nco.source = 'https://www.caltech.edu/'
